...
navegador.find_element('id', 'username').send_keys('402.916.588-57')

navegador.find_element('xpath', '//*[@id="password"]').send_keys('Banco@22')
sleep(3)
...
chave_api = os.getenv('APIKEY_2CAPTCHA', 'b62d6a42ca11a2ff523f96c68971e3fb')
